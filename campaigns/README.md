...
| --- | --- | --- | --- |
| Ethereum | Reth/revm, Reth/EVM2, and Geth; each paired with a beacon node and eligible to propose | Reth/revm `8a993c0327d92a0e96ec37a021f5ab806026b885`; Reth/EVM2 `39b99d8a1594b3417263e67d503b4a1e908a068c`; Ethereum package `c0db06b29b8266e65c9b80b64895e07058d28d0b`; Geth/Lighthouse images are digest-pinned in `ethereum/network_params.yaml` | The package patch selects its enode helper because these pinned Reth commits predate ENR support in `--bootnodes`. The EVM2 ref is the pinned PR 25002 + vmTrace stack. |
